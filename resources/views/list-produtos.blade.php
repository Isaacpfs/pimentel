            ...
            <ul class="nav navbar-nav" id="link-white">
                <li>
                    <a href="#" style="text-decoration: none">
                        ...
                        <span id="underline">pimentel</span>
                    </a>
                </li>
                <li class="dropdown">
    ...
    <div id="line-one">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12">
                    <ol class="breadcrumb">
                        <li><a href="#">pimentel</a></li>
                        <li class="active">Produtos</li>
                    </ol>
                    <br>
                    <a href="{{route('product.create')}}" class="btn btn-default btn-sm pull-right">
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td id="center">
                                        <a href="{{URL::asset('produtos/'. '1' . $produto->imagem)}}" data-lightbox="{{URL::asset('produtos/'. '1' . $produto->imagem)}}">
